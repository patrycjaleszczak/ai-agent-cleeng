...
test('POST /subscriptions/{subscriptionId}/activate - Activate subscription', async () => {
  ...
  await client.init();
  try {
    const templatePath = '/subscriptions/{subscriptionId}/activate';
    ...
    await expectStatusOk(res, 'POST /subscriptions/{subscriptionId}/activate');
  } finally {
