...
test('POST /subscriptions/{subscriptionId}/terminate - Terminate subscription', async () => {
  ...
  await client.init();
  try {
    const templatePath = '/subscriptions/{subscriptionId}/terminate';
    ...
    await expectStatusOk(res, 'POST /subscriptions/{subscriptionId}/terminate');
  } finally {
