...
test('POST /subscriptions/{subscriptionId}/resume - Resumes subscription from scheduled pause', async () => {
  ...
  await client.init();
  try {
    const templatePath = '/subscriptions/{subscriptionId}/resume';
    ...
    await expectStatusOk(res, 'POST /subscriptions/{subscriptionId}/resume');
  } finally {
