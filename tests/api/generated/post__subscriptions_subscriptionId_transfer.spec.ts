...
test('POST /subscriptions/{subscriptionId}/transfer - Transfer subscription', async () => {
  ...
  await client.init();
  try {
    const templatePath = '/subscriptions/{subscriptionId}/transfer';
    ...
    await expectStatusOk(res, 'POST /subscriptions/{subscriptionId}/transfer');
  } finally {
