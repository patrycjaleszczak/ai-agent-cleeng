...
test('POST /subscriptions/{subscriptionId}/pause - Pause subscription', async () => {
  ...
  await client.init();
  try {
    const templatePath = '/subscriptions/{subscriptionId}/pause';
    ...
    await expectStatusOk(res, 'POST /subscriptions/{subscriptionId}/pause');
  } finally {
