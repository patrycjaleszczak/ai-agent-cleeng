...
test('POST /subscriptions/{subscriptionId}/renew - Renew an externally managed subscription', async () => {
  ...
  await client.init();
  try {
    const templatePath = '/subscriptions/{subscriptionId}/renew';
    ...
    await expectStatusOk(res, 'POST /subscriptions/{subscriptionId}/renew');
  } finally {
